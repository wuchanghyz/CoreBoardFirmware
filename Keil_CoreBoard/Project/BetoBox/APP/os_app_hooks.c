...
{
	I2C_system_tick(&g_core_i2c[0], 1);
	I2C_system_tick(&g_core_i2c[1], 1);
	I2C_system_tick(&g_core_i2c[2], 1);
	I2C_system_tick(&g_core_i2c[3], 1);
	I2C_system_tick(&g_core_i2c[4], 1);
	I2C_system_tick(&g_core_i2c[5], 1);
	I2C_system_tick(&g_core_i2c[6], 1);
	I2C_system_tick(&g_core_i2c[7], 1);
	I2C_system_tick(&g_core_i2c[8], 1);
	I2C_system_tick(&g_core_i2c[9], 1);
}
