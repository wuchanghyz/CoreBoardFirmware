...
void  BSP_Init (void)
{
	...
	NVIC_enable_interrupt(1);
	NVIC_enable_interrupt(2);
	NVIC_enable_interrupt(3);
	NVIC_enable_interrupt(4);
	NVIC_enable_interrupt(5);
	NVIC_enable_interrupt(6);
	NVIC_enable_interrupt(7);
	NVIC_enable_interrupt(8);
	NVIC_enable_interrupt(9);
	NVIC_enable_interrupt(10);
	NVIC_enable_interrupt(11);
	NVIC_enable_interrupt(12);
	NVIC_enable_interrupt(13);
	NVIC_enable_interrupt(14);
...
void  BSP_CPU_TickInit  (void)
{
    ...
    cnts         = (MSS_SYS_M3_CLK_FREQ / OSCfg_TickRate_Hz);          /* Determine nbr SysTick increments                     */
