...
save
set has_violations {C:\Users\AndersonHan\Desktop\BentoBox\Fpga\designer\M2sExt\M2sExt_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {C:\Users\AndersonHan\Desktop\BentoBox\Fpga\designer\M2sExt\M2sExt_combinational_loops.xml}
if { [catch "file delete -force -- {C:\Users\AndersonHan\Desktop\BentoBox\Fpga\designer\M2sExt\pinslacks.txt}"] } {
   ;
}
report -type slack {C:\Users\AndersonHan\Desktop\BentoBox\Fpga\designer\M2sExt\pinslacks.txt}
