...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\AndersonHan\Desktop\BentoBox\Fpga\synthesis\M2sExt.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\AndersonHan\Desktop\BentoBox\Fpga\constraint\io\M2sExt.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\AndersonHan\Desktop\BentoBox\Fpga\constraint\fp\M2sExt.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\AndersonHan\Desktop\BentoBox\Fpga\designer\M2sExt} \
    -design M2sExt \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg fg484 \
    -pdc_file {C:\Users\AndersonHan\Desktop\BentoBox\Fpga\constraint\io\M2sExt.io.pdc} \
    -pdc_file {C:\Users\AndersonHan\Desktop\BentoBox\Fpga\constraint\fp\M2sExt.fp.pdc} \
    -merge_pdc 0
